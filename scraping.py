...
def scrape_all():
    # Initiate headless driver deployment
...
def mars_news(browser):
    ...
    # Convert the browser html to a soup object and then close the browser
    html = browser.html
    news_soup = soup(html, 'html.parser')

    # Add try/except for error catch
    try:
...
def featured_image(browser):
    ...
    browser.visit(url)
    # ******WAIT FOR PAGE TO COMPLETELY LOAD!!! High Latency******
...
def mars_facts():
    ...
    try:
        # Used 'read_html' to scrape the facts table into dataframe
        df = pd.read_html("http://space-facts.com/mars/")[0]
    
    except BaseException:
        return None

    # Assign columns and index of dataframe
...
if __name__ == '__main__':
    ...
    # If running script, print scraped dated
    print(scrape_all())